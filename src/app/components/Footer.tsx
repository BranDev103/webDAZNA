    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="text-2xl mb-4 text-blue-600">CONSTRUCTORA DAZNA S.A de C.V.</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><a href="#servicios" className="hover:text-blue-600 transition-colors">Construcción Residencial</a></li>
              <li><a href="#servicios" className="hover:text-blue-600 transition-colors">Construcción Comercial</a></li>
              <li><a href="#servicios" className="hover:text-blue-600 transition-colors">Construcción Industrial</a></li>
              <li><a href="#servicios" className="hover:text-blue-600 transition-colors">Remodelaciones</a></li>
            </ul>
          </div>
